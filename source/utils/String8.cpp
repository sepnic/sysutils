...
bool String8::setTo(const char* other)
{
...
bool String8::setTo(const char* other, size_t len)
{
...
bool String8::setTo(const char16_t* other, size_t len)
{
...
bool String8::setTo(const char32_t* other, size_t len)
{
...
bool String8::append(const String8& other)
{
...
bool String8::append(const char* other)
{
    return append(other, strlen(other));
}

bool String8::append(const char* other, size_t otherLen)
{
    if (bytes() == 0) {
...
bool String8::appendFormat(const char* fmt, ...)
{
    va_list args;
    va_start(args, fmt);

    bool result = appendFormatV(fmt, args);

    va_end(args);
    return result;
}

bool String8::appendFormatV(const char* fmt, va_list args)
{
    int n, result = true;
    va_list tmp_args;
...
bool String8::real_append(const char* other, size_t otherLen)
{
...
bool String8::unlockBuffer(size_t size)
{
    if (size != this->size()) {
        SharedBuffer* buf = SharedBuffer::bufferFromData(mString)
            ->editResize(size+1);
