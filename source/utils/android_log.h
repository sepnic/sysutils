...
#ifndef __MSGUTILS_ANDROID_LOG_H__
#define __MSGUTILS_ANDROID_LOG_H__
...
#define ALOG_ALWAYS_FATAL_IF(cond, ...) OS_ASSERT(!(cond), LOG_TAG, ##__VA_ARGS__)
#define ALOG_ASSERT(cond, ...) OS_ASSERT(cond, LOG_TAG, ##__VA_ARGS__)

#endif // __MSGUTILS_ANDROID_LOG_H__
