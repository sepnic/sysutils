...
template std::string StringUtils::Join(const std::vector<std::string>&, char);
template std::string StringUtils::Join(const std::vector<const char*>&, char);
template std::string StringUtils::Join(const std::vector<std::string>&, const std::string&);
template std::string StringUtils::Join(const std::vector<const char*>&, const std::string&);

bool StringUtils::StartsWith(const std::string& s, const char* prefix) {
  return strncmp(s.c_str(), prefix, strlen(prefix)) == 0;
}

bool StringUtils::StartsWithIgnoreCase(const std::string& s, const char* prefix) {
  return strncasecmp(s.c_str(), prefix, strlen(prefix)) == 0;
}

static bool StringEndsWith(const std::string& s, const char* suffix, bool case_sensitive) {
...
bool StringUtils::EndsWith(const std::string& s, const char* suffix) {
  return StringEndsWith(s, suffix, true);
}

bool StringUtils::EndsWithIgnoreCase(const std::string& s, const char* suffix) {
  return StringEndsWith(s, suffix, false);
}
