...
public:
     ...
     */
     ...
     inline int             sort(compar_t cmp);
     inline int             sort(compar_r_t cmp, void* state);
...
template<class TYPE> inline
int Vector<TYPE>::sort(Vector<TYPE>::compar_t cmp) {
    return VectorImpl::sort(reinterpret_cast<VectorImpl::compar_t>(cmp));
}

template<class TYPE> inline
int Vector<TYPE>::sort(Vector<TYPE>::compar_r_t cmp, void* state) {
