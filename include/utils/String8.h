...
public:
    ...
    inline  bool                isEmpty() const;
            ...
            bool                setTo(const char* other);
            bool                setTo(const char* other, size_t numChars);
            bool                setTo(const char16_t* other, size_t numChars);
            bool                setTo(const char32_t* other,
                                      size_t length);

            bool                append(const String8& other);
            bool                append(const char* other);
            bool                append(const char* other, size_t numChars);
...
private:
            bool                real_append(const char* other, size_t numChars);
